...
function append_row(table_id, row_id, c1, c2, c3, c4, c5)
{
    ...
    var cell_4 = row.insertCell(3);
    var cell_5 = row.insertCell(4);
    cell_1.innerHTML = "<img src="+c1+" width="+"100"+" height="+"100"+">";
    cell_2.innerHTML = c2;
    cell_3.innerHTML = c3;
    cell_4.innerHTML = c4;
    cell_5.innerHTML = c5;
...
{
    create_table("table1");
    append_header_row("table1", 0, "Image", "Price", "Rating", "Delivery Time", "Details");
    append_row("table1", 1, "images/2.jpeg", "12", "48", "xx", "Link");
    append_row("table1", 2, "images/3.jpeg", "45", "199", "x", "Link");
    append_row("table1", 3, "images/4.jpeg", "60", "145", "xx", "Link");
    append_row("table1", 4, "images/5.jpeg", "1000", "4000", "xx", "Link");
}
